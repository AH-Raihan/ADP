         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" placeholder="Enter Writer Name..." class="medium" />
                    </td>
                </tr>
				<!-- <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" placeholder="Enter Sale Price..." class="medium" />
                    </td>
                </tr>
				...
				<tr>
                    ...
                    <td>
                        <select id="select" name="select">
                            ...
                            <option value="1">Subject Bittik</option>
                            <option value="2">Suggetion</option>
                        </select>
                    </td>
                </tr>
